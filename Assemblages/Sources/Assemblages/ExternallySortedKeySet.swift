...
//import Foundation
//
//public protocol ExternallySortable: Identifiable {
//    static func compare(_ a: Self, _ b: Self) -> Bool
//}
//
//private final class ElementReference<Element: ExternallySortable> {
//    let element: Element
//}
//
//
///// The `ExternallySortedKeySet` is a `KeySet` that tracks sorting in an external array.
//public struct ExternallySortedKeySet<Element: ExternallySortable> {
//    public init() {
//        storage = [:]
//        sorted = []
//    }
...
//}
//
//extension ExternallySortedKeySet: Codable where Element: Codable, Element.ID: Codable {
...
//}
//
//extension ExternallySortedKeySet: ExternallySortedKeySetPublicInterface { }
//private protocol ExternallySortedKeySetPublicInterface {
